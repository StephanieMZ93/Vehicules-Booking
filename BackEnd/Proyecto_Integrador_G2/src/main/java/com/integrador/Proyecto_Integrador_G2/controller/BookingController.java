...
public class BookingController {
    ...
    public ResponseEntity<Booking> searchBookingById(@PathVariable Long id) throws ResourceNotFoundException {
        Optional<Booking> booking = bookingService.searchBooking(id);
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<Void> deleteBookingById(@PathVariable Long id) throws ResourceNotFoundException {
        Optional<Booking> booking = bookingService.searchBooking(id);
        if (booking.isPresent()) {

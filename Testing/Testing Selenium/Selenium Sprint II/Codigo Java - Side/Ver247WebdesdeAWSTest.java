...
import java.net.URL;
public class Ver247WebdesdeAWSTest {
  ...
  public void ver247WebdesdeAWS() {
    ...
    driver.findElement(By.cssSelector(".headerBlock__left")).click();
    driver.findElement(By.cssSelector(".header__left img")).click();
    js.executeScript("window.scrollTo(0,500)");
    driver.findElement(By.cssSelector(".category:nth-child(1) > h2")).click();
